...
const InteractionWithTweet = ({individual,style}) => {
  return (
    <div className={`flex flex-row justify-between items-center ${style} h-8 p-4 pl-10 pr-0  `}>
                <div onClick={()=>document.getElementById("AddComment").showModal()} className="cursor-pointer">
